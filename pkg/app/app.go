...
import (
	...
	"github.com/robinlg/iamlib/pkg/cli/globalflag"
	"github.com/robinlg/iamlib/pkg/term"
	"github.com/robinlg/iamlib/pkg/version"
	"github.com/robinlg/iamlib/pkg/version/verflag"
...
func (a *App) buildCommand() {
	...
	globalFS := namedFlagSets.FlagSet("global")
	if !a.noVersion {
		verflag.AddFlags(globalFS)
	}
	if !a.noConfig {
		addConfigFlag(a.basename, globalFS)
	}
	globalflag.AddGlobalFlags(globalFS, cmd.Name())
