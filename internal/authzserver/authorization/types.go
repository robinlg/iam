...
//go:generate mockgen -destination mock_authorization.go -package authorization github.com/robinlg/iam/internal/authzserver/authorization AuthorizationInterface
