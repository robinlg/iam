...
访问 https://github.com/robinlg/iam，点击右上角 **Fork** 按钮。fork 后的仓库地址为：https://github.com/colin404fork/iam。
...
$ cd iam
$ git remote add upstream https://github.com/robinlg/iam
...
upstream	https://github.com/robinlg/iam (fetch)
upstream	https://github.com/robinlg/iam (push)
```
...
/home/colin/workspace/golang/src/github.com/robinlg/iam/pkg/db/db.go
...
...
```bash
$ make add-copyright
/home/colin/workspace/golang/src/github.com/robinlg/iam/pkg/db/db.go added license
```
